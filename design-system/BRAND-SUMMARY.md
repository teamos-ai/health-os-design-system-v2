...
| Headlines | Every H1 in dark ink with one descriptive word in soft apricot, and a picture tile beside that word that literally shows it. Twenty ready lines and an 80-tile squircle library |
...
- The headline: one apricot word and the picture tile beside it, which rises in once.
