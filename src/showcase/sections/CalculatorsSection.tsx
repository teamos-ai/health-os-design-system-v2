              ...
              {rows.map((row, i) => (
                <div key={row.id} className="grid grid-cols-[1fr_7rem_2.75rem] gap-3">
                  <input
                    ...
                    className="h-11 min-w-0 rounded-md border border-line bg-surface px-3 font-sans text-body text-ink-900 placeholder:text-ink-400 focus:border-apricot-400 focus:outline-none focus:ring-2 focus:ring-apricot-200"
                  />
                  <input
                    ...
                    className="h-11 min-w-0 rounded-md border border-line bg-surface px-3 font-sans text-body tabular-nums text-ink-900 placeholder:text-ink-400 focus:border-apricot-400 focus:outline-none focus:ring-2 focus:ring-apricot-200"
                  />
                  <IconButton
                    variant="text"
