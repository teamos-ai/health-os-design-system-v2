  ...
  <Section id="live" className="border-b-0 [&>div]:max-w-6xl">
    <div className="overflow-hidden rounded-lg border border-line bg-surface shadow-lg">
      ...
      <div
        ...
        tabIndex={0}
        className="max-h-[80vh] overflow-y-auto bg-paper [scrollbar-width:thin] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-inset focus-visible:ring-ink-900"
      >
        <Ticker />
        <Nav sticky={false} />
