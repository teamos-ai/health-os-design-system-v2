 ...
 * figure, table of contents beside the reading column, pull quote on an apricot rule, a
...
import { ArticleMeta, AuthorNote, CategoryFilter, FeaturedPost, PullQuote, TableOfContents, type Author, type PostSummary } from '@/components/blog/Blog';
...
const PRIYA: Author = { name: 'Priya Kapoor', initials: 'PK', role: 'Studio owner', accent: 'apricot' };
    ...
    <Example id="article" label="Article page">
      <article id="blog-article" className="mx-auto max-w-4xl scroll-mt-8 py-4">
        ...
        <div className="mt-12 grid gap-10 lg:grid-cols-[12rem_1fr]">
          <TableOfContents items={TOC} className="self-start" />
        ...
        <section aria-labelledby="blog-related" className="mt-16 border-t border-line pt-10">
          ...
          <div className="mt-6 grid gap-6 md:grid-cols-2">
            {POSTS.filter((p) => p.category === 'Operations').map((p) => (
